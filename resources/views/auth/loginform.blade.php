    ...
    <div class="min-h-screen flex items-center justify-center py-8 px-4">
        <div class="w-full max-w-5xl bg-white    rounded-2xl shadow-2xl overflow-hidden grid grid-cols-1 lg:grid-cols-2">
            ...
            <div class="p-8 lg:p-12 flex flex-col justify-center">
                ...
                @if (session('error'))
                    <div
                        class="mb-6 px-4 py-3 bg-red-100 border-l-4 border-red-500 text-red-700 rounded-lg flex items-center justify-between">
                ...
                <form action="{{ route('login.store') }}" method="POST" class="space-y-5">
                    ...
                    <div>
                        ...
                        <x-form-input type="text" name="username" placeholder="Enter your username" />
                    </div>
                ...
                <div class="mt-6 text-center">
                    <p class="text-sm text-gray-600">
                        ...
                        <a href="{{ route('login.admin') }}"
                            class="text-secondary-400 hover:text-secondary-500 font-semibold">Login here</a>
                    </p>
                </div>
            </div>
            ...
            <div
                class="hidden lg:flex bg-gradient-to-br from-secondary-400 to-secondary-300 p-12 flex-col items-center justify-center text-white relative overflow-hidden">
                ...
                <div class="relative z-10 text-center">
                    ...
                    <div class="mb-8">
                        <div
                            class="w-32 h-32 mx-auto rounded-2xl bg-white shadow-xl flex items-center justify-center ring-4 ring-secondary-400/20">
                            <img src="{{ asset('Assets/Logo/Logo-MTs-Nurul-Islam-Cisauk.png') }}" alt="Logo MTs Nurul Islam"
                    ...
                    <div class="space-y-4 text-left max-w-xs mx-auto">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <span class="text-white/90">Automated Essay Correction</span>
                        </div>
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 bg-white/20 rounded-lg flex items-center justify-center flex-shrink-0">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
