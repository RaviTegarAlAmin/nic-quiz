<form wire:submit="import" class="space-y-4">
    <div x-data="{ drag: false }" @dragover.prevent="drag = true" @dragleave.prevent="drag = false"
        ...
        <input type="file" accept=".xlsx,.xls" class="hidden" x-ref="file" wire:model="excelFile" id="teacher-excel-upload">

        <label for="teacher-excel-upload" class="cursor-pointer flex flex-col items-center gap-3">
