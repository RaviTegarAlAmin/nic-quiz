        ...
        @foreach ($questions as $index => $question)
            <div wire:key="question-{{ $index }}">
                ...
                <x-card
                    ...
                    x-data="{ minimize: $wire.entangle('minimize.{{ $question['id'] }}') }">
                    {{-- Header function --}}
                    ...
                    <div x-show="!minimize" class=" grid grid-cols-4 gap-4 mb-4">
                        ...
                        <div class=" row-span-2 col-span-3">
                            ...
                            <x-form-input type="textarea" :row="4"
                                wire:model="questions.{{ $index }}.question"></x-form-input>
                        </div>

                        <div>
                            <x-label>Tipe Soal</x-label>
                            <select wire:model.live.debounce.500ms="questions.{{ $index }}.type"
                                id="question.type"
                        ...
                        <div class="mb-4">
                            ...
                            <x-form-input min="1" type="number"
                                wire:model.live.debounce.500ms="questions.{{ $index }}.weight" />
                            @error('weight')
                                {{ $message }}
                            @enderror
                        </div>
